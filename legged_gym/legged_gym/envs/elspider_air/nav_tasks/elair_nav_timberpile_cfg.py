...
class ElAirNavTimberPileCfg(ElSpiderAirNavCfg):
    ...
    class navi_opt(ElSpiderAirNavCfg.navi_opt):
        ...
        start_pos = [
            [3.2, 3.2, 0.9],  # Environment 0
        ]
        
        # Corresponding goal positions
        goal_pos = [
            [9.6, 3.2, 0.9],  # Goal for Environment 0
        ]
...
class ElAirNavTimberPileCfgPPO(ElSpiderAirNavCfgPPO):
